...
public class RowTest {
	...
	public void header() {
		...
		assertEqualsWithFile(context.getHeader().each(1), getClass(), "header-bofore1");
		assertEqualsWithFile(context.getHeader().each(2), getClass(), "header-bofore2");
		assertEqualsWithFile(context.getHeader().each(3), getClass(), "header-bofore3");
		...
		assertThat(context.getHeader().getDepth(), is(3));
		assertEqualsWithFile(context.getHeader().each(1), getClass(), "header-after1");
		assertEqualsWithFile(context.getHeader().each(2), getClass(), "header-after2");
		assertEqualsWithFile(context.getHeader().each(3), getClass(), "header-after3");
	}
}
